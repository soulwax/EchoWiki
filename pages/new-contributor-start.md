...
5. Pick one small contribution and find the right route in [Change Routes](pages/change-routes.md).
...
Use [Change Routes](pages/change-routes.md). If a change does not fit any route, it may need a design note before code.
